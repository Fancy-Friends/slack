 ...
 */
/**
 * Every Slack node executor — the PHP twin of `SLACK_RUNNABLE_KINDS` in
 * @particle-academy/slack-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `SlackFlow::register($kinds, $executors)` — one call, no directory scan.
